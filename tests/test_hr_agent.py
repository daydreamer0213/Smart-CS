...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("年假按制度执行。[source:policy-1] [source:]", "我无法在未检索到授权 HR 制度来源的情况下确认该政策。请补充信息或申请 HR 人工支持。"),
        ("年假按制度执行。[source:policy-1] [source:other policy]", "我无法在未检索到授权 HR 制度来源的情况下确认该政策。请补充信息或申请 HR 人工支持。"),
